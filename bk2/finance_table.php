...
$bajaj_ta_matched_query = "SELECT a.id
				...
				JOIN happi_bajaj_apx_transactions c ON(c.apr_no = b.do_id AND c.trn_date = a.trans_date) 
                JOIN happi_dbd_master_data d ON(d.invoice_no = c.invoice_no AND d.doc_date = a.trans_date) 
...
$idfc_ta_matched_query = "SELECT a.id				
				...
				JOIN happi_idfc_apx_transactions c ON(c.apr_no = b.sfdc_id AND c.trn_date = a.value_date) 
				JOIN happi_dbd_master_data d ON(d.invoice_no = c.invoice_no AND d.doc_date = a.value_date) 
...
$apx_bajaj_matched_query = "SELECT a.* FROM happi_bajaj_apx_transactions a join happi_bajaj_do_transactions c on (c.do_id = a.apr_no) join happi_bajaj_ta_transactions d on (d.txn_id = c.app_cas_id AND a.trn_date = d.trans_date) join happi_dbd_master_data b on (b.invoice_no = a.invoice_no AND b.doc_date = a.trn_date) where a.trn_date = '$get_date'";
// echo $u_query;exit;
					 ...
					 <table border="1" class="table result-table" cellspacing="0" style=" text-align: center;width:100%;">
						...
						<tbody style="background-color: #d3d3d3;">
							<tr>
								...
								<td><strong><?php echo formatIndianCurrency($bajaj_ta_total);?></strong></td>
								<td><strong><?php echo formatIndianCurrency($bajaj_ta_amt_fn - $bajaj_ta_total);?></strong></td>
							</tr>
							
							<tr>
								<td><strong>Bajaj Apx Report</strong></td>
								<td><strong><?php echo $apx_total_cnt;?></strong></td>
								<td><strong><a href="dwd_bajaj_apx.php?get_date=<?php echo $get_date;?>"><?php echo $apx_bajaj_matched_count ;?></a></strong></td>
								<td><strong><a href="dwd_notm_bajaj_apx.php?get_date=<?php echo $get_date;?>"><?php echo $apx_total_cnt - $apx_bajaj_matched_count ;?></a></strong></td>
							...
							<tr>
								...
								<td><strong><?php echo formatIndianCurrency($idfc_ta_total);?></strong></td>
								<td><strong><?php echo formatIndianCurrency($idfc_ta_amt_fn);?></strong></td>
							</tr>
							<tr>
								<td><strong>IDFC Apx Report</strong></td>
								<td><strong><?php echo $apx_idfc_total_cnt;?></strong></td>
								<td><strong><a href="dwd_idfc_apx.php?get_date=<?php echo $get_date;?>"><?php echo $apx_idfc_matched_count ;?></a></strong></td>
								<td><strong><a href="dwd_notm_idfc_apx.php?get_date=<?php echo $get_date;?>"><?php echo $apx_idfc_total_cnt - $apx_idfc_matched_count ;?></a></strong></td>
