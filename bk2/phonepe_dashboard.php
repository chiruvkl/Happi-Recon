...
$where = " ";
if($trans_type != ''){
	$where .= " AND a.acquirer = '$trans_type' ";
}
if($store_name != ''){
	$where .= " AND a.store_name = '$store_name' ";
}
...
$u_query = "SELECT a.*, c.voucher_no, c.apr_no, c.invoice_no, c.trn_date, c.amount AS apx_amt
				...
				where a.datetime = '$get_date' AND a.acquirer = 'PHONEPE' ".$where."
				ORDER BY a.id ASC";
...
$acquirer_query = "SELECT store_name FROM happi_all_transactions where datetime = '$get_date' AND acquirer = 'PHONEPE' GROUP BY store_name ORDER BY store_name ASC";  
					...
					foreach($u_res_data as $row){
						...
						$diffamt = $apx_amt - $txn_amount;
						  ...
						  <td><div class="form-group col-md-12"><strong><?php echo $row['pos']; ?></strong></div></td>
							...
							<td><div class="form-group col-md-12"><strong><?php echo $row['payment_mode']; ?></strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php echo $row['datetime']; ?></strong></div></td>
							...
							<td><div class="form-group col-md-12"><strong><?php echo $row['bill_invoice']; ?></strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php echo $row['amount']; ?></strong></div></td>
