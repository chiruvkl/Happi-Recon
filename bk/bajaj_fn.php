...
$u_query = "SELECT a.*, b.do_id, b.dis_val, c.voucher_no, c.apr_no, c.invoice_no AS apx_invoice_no, c.trn_date, c.amount AS apx_amt
						 ...
						 */
						 ...
						 if($apx_amt == 0){
						  ...
						  <td><div class="form-group col-md-12"><strong><?php echo $row['branch_name']; ?></strong></div></td>
							...
							<td><div class="form-group col-md-12"><strong><?php echo $dbm_main - $row['dis_val']; ?></strong></div></td>
