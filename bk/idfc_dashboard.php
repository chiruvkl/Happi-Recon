					  ...
					  <thead>
						<tr style="background-color:#d4d7dd;">
						  ...
						  <th scope="col"><strong>Branch Name</strong></th>
							...
							<th scope="col"><strong>APX DBD</strong></th>
						 ...
						 */
						 ...
						 if($apx_amt == 0){
						  ...
						  <td><div class="form-group col-md-12"><strong><?php echo $row['salespoint_name']; ?></strong></div></td>
							...
							<td><div class="form-group col-md-12"><strong><?php echo $row['transaction_date']; ?></strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php echo $row['sfdc_id']; ?></strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php echo $row['application_id']; ?></strong></div></td>
							...
							<td><div class="form-group col-md-12"><strong><?php echo $dbm_main - $row['dbd_inlclude_gst']; ?></strong></div></td>
