...
/* $u_query = "SELECT a.*, b.voucher_no, b.apr_no, b.invoice_no, b.trn_date, b.amount AS apx_amt, h.card_type, h.trans_date, h.settle_date, h.approve_code, h.domestic_amt, h.net_amount 
				FROM happi_all_transactions a 
				LEFT JOIN happi_apx_transactions b ON(b.apr_no = a.approval_code) 
				LEFT JOIN happi_hdfc_transactions h ON(h.approve_code = a.approval_code) 
				where a.datetime = '$get_date' AND a.acquirer = 'HDFC' ".$where."
...
$acquirer_query = "SELECT store_name FROM happi_all_transactions where datetime = '$get_date' AND acquirer = 'HDFC' GROUP BY store_name ORDER BY store_name ASC";  
					...
					<table class="table table-bordered" id="zero_config">
					  <thead>
						<tr style="background-color:#d4d7dd;">
						  ...
						  <th scope="col"><strong>POS NO</strong></th>
							<th scope="col"><strong>TID Number</strong></th>
							<th scope="col"><strong>Store Name</strong></th>
							<th scope="col"><strong>CARD TYPE</strong></th>
							<th scope="col"><strong>TRANS DATE</strong></th>
							<th scope="col"><strong>SETTLE DATE</strong></th>
							<th scope="col"><strong>TXN Id</strong></th>
							<th scope="col"><strong>RRN No</strong></th>
							<th scope="col"><strong>APPROV CODE</strong></th>
							<th scope="col"><strong>DOMESTIC AMT</strong></th>
							...
							<th scope="col"><strong>enty type</strong></th>
							<th scope="col"><strong>TXN Rate</strong></th>
							<th scope="col"><strong>Debuted MDR</strong></th>
					...
					foreach($u_res_data as $row){
						...
						if($apx_amt > 2000){
						  ...
						  <td><div class="form-group col-md-12"><strong><?php echo $row['pos']; ?></strong></div></td>
							...
							<td><div class="form-group col-md-12"><strong><?php echo $row['store_name']; ?></strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php echo $row['card_type_trns']; ?></strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php echo $row['trans_date']; ?></strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php echo $row['settle_date']; ?></strong></div></td>
							...
							<td><div class="form-group col-md-12"><strong><?php echo $row['approve_code']; ?></strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php echo $row['domestic_amt']; ?></strong></div></td>
							...
							<td><div class="form-group col-md-12"><strong><?php echo ($row['apx_amt'] - $row['domestic_amt']); ?></strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php echo ($row['domestic_amt'] - $row['net_amount']); ?></strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php echo round((($row['domestic_amt'] - $row['net_amount']) / $row['domestic_amt']) * 100 , 2); ?>%</strong></div></td>
							...
							<td><div class="form-group col-md-12"><strong><?php $debutedmdr = ($row['domestic_amt'] - $row['net_amount']); echo round($debutedmdr, 2); ?></strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php echo round((($row['domestic_amt'] - $row['net_amount']) / $row['domestic_amt']) * 100 , 2); ?>%</strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php echo $mdrper;?>%</strong></div></td>
							<td><div class="form-group col-md-12"><strong><?php $actual_mdr = round( ($mdrper / 100) * $row['domestic_amt'], 2); echo $actual_mdr; ?></strong></div></td>
