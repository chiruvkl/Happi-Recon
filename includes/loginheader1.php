<?php
	...
	$nice_admin_loggedin = (isset($_SESSION['nice_admin_loggedin']['id']) && $_SESSION['nice_admin_loggedin']['id'] != '') ? TRUE : FALSE;
	//echo $nice_admin_loggedin;
	if($nice_admin_loggedin)
	{
		...
		{
			unset($_SESSION['nice_admin_loggedin']);	
		...
		$admin_id = $_SESSION['nice_admin_loggedin']['id'];
      ...
      <header class="topbar" data-navbarbg="skin5">
        <nav class="navbar top-navbar navbar-expand-md navbar-dark">
          <div class="navbar-header" data-logobg="skin5">
            ...
            <!-- Logo -->
            <!-- ============================================================== -->
            <a class="navbar-brand" href="sites.php">
              <!-- Logo icon -->
              ...
              <span class="logo-text ms-2">
                ...
                <img
                  src="images/logo2.png"
                  alt="homepage"
                  class="light-logo" style="width:40%;"
                />
              </span>
              <!-- Logo icon -->
              <!-- <b class="logo-icon"> -->
