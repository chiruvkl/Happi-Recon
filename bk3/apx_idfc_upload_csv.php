					...
					if($voucher_no != '' && $apr_no != '' && $invoice_no != ''){					
						...
						$id = $res['id'];
							if($res['id'] == ''){
								...
								$qry = "INSERT INTO happi_idfc_apx_transactions (voucher_no,card_no,apr_no,invoice_no, amount, trn_date, created_on, fin_type, upload_date) 
								VALUES ('$voucher_no', '$card_no','$apr_no', '$invoice_no', '$amount','$trn_date','$timestamp', 'IDFC', '$upload_date')";
								...
								$qry = "UPDATE happi_idfc_apx_transactions SET 
									card_no = '$card_no',
									apr_no = '$apr_no',
