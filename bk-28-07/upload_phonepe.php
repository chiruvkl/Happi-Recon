...
?>    
      ...
      <div class="page-wrapper">
            ...
            <div class="col-12 d-flex no-block align-items-center">
              ...
              <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="uploads.php">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">
                     Phonepe Settlement Report
                    </li>
                  </ol>
                </nav>
              </div>
		...
		?>		
			  ...
			  <div class="card"><h4 class="page-title text-center">Phonepe Settlement Report</h4>
			 
                <form class="form-horizontal2" name="frmadd2" id="frmadd2" method="post" action="phonepe_upload_csv.php" enctype="multipart/form-data" >
                  ...
                  <div class="border-top text-center">
                    <div class="card-body">
                      <button type="submit" id="submit" class="btn btn-primary" name="sbmtbtn2">
					   ...
					   <a type="button" class="btn btn-warning" href="uploads.php"><i class="fa fa-repeat"></i>&nbsp;Back</a> <a type="button" class="btn btn-success" href="dashboard.php"><i class="fa fa-repeat"></i>&nbsp;Home</a>
                    </div>
