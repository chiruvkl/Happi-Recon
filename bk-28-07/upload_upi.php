...
?>    
      ...
      <div class="page-wrapper">
		...
		?>		
			  ...
			  <div class="card"><h4 class="page-title text-center">UPI Transactions Report</h4>
			 
                <form class="form-horizontal2" name="frmadd2" id="frmadd2" method="post" action="upi_upload_csv.php" enctype="multipart/form-data" >
