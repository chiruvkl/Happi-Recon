				...
				while(($line = fgetcsv($csvFile)) !== FALSE){
					...
					if($neft_utr_no != '' && $application_id != ''&& $sfdc_id != ''){			
						...
						if($res['id'] == ''){
							...
							$qry = "UPDATE happi_idfc_ta_transactions SET 
								sfdc_id = '$sfdc_id', 
								applicant_name = '$applicant_name', 
								tenure = '$tenure', 
								no_of_adv_emi = '$no_of_adv_emi', 
								...
								net_disbursal_mount = '$net_disbursal_mount', 
								neft_utr_no = '$neft_utr_no', 
								transaction_date = '$transaction_date', 
								actual_amount_paid = '$actual_amount_paid', 
								dbd_inlclude_gst = '$dbd_inlclude_gst'
							WHERE id = '$id' ";
							$r = mysqli_query($conn, $qry);
						}
