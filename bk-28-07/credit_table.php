					 ...
					 <table border="1" class="table result-table" cellspacing="0" style=" text-align: center;width:100%;">
						...
						<tbody style="background-color: #d3d3d3;">
							<tr>
								...
								<td><strong><a href="dwd_pine.php?get_date=<?php echo $get_date;?>"><?php echo $total_matched_cnt;?></a></strong></td>
								<td><strong><a href="dwd_notm_pine.php?get_date=<?php echo $get_date;?>"><?php echo $pine_total_cnt - $total_matched_cnt;?></a></strong></td>
