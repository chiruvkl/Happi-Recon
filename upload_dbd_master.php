...
?>    
      ...
      <div class="page-wrapper">
		...
		?>		
			  ...
			  <div class="card"><h4 class="page-title text-center">DBD MASTER DATA</h4>
			 
                <form class="form-horizontal2" name="frmadd2" id="frmadd2" method="post" action="dbd_master_upload_csv.php" enctype="multipart/form-data" >
